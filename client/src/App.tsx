...
const moduleMeta: Record<ModuleKey, { label: string; short: string; helper: string }> = {
  ...
  dashboard: { label: "Dashboard", short: "DB", helper: "Visão estratégica do negócio" },
  ...
  vendas: { label: "Vendas", short: "VD", helper: "Receita, pedidos e faturamento" },
  compras: { label: "Compras", short: "CP", helper: "Suprimentos, aprovação e recebimento" },
  despesas: { label: "Despesas", short: "DP", helper: "Custos operacionais e previsibilidade" },
  fornecedores: { label: "Fornecedores", short: "FR", helper: "Cadastro de fornecedores" },
  financeiro: { label: "Financeiro", short: "FN", helper: "Gestão de caixa e movimentações" },
  contaCorrente: { label: "Conta Corrente", short: "CC", helper: "Extrato executivo do caixa" },
